...
public class TileGenerator : MonoBehaviour
{
   public GameObject Tile1;
    ...
    private void Start()
    {
        ...
        InvokeRepeating("tileSpeedFunction", 4f, 4f);
    }

    private void Update()
    {
        gameObject.transform.position += new Vector3(tileSpeed * Time.deltaTime, 0, 0);
